...
export default function AdminProductsItemsPage() {
  const nav = [
            ...
            {nav.map((item) => (
              <a
                ...
                className={[
                  ...
                  item.href === "/admin/products" ? "bg-white/75" : "hover:bg-white/60",
                ].join(" ")}
              >
          ...
          <div className="mt-auto px-6 pb-7">
            <div className="flex items-center gap-3 rounded-2xl bg-white/60 px-4 py-4">
              ...
              <div className="min-w-0">
                <div className="text-sm font-semibold leading-tight">Curator Admin</div>
                <div className="text-xs tracking-wide uppercase opacity-70">System manager</div>
              </div>
            </div>
            <Link
              href="/"
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-10 bg-[#f7faf4]">
            <div className="flex items-center justify-between px-6 py-4 sm:px-10">
              <div className="text-base font-semibold tracking-tight">Products</div>
              <button
                type="button"
